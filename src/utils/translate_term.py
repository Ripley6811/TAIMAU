...
worddict = {
    ...
    u"\u26DF Create Single Shipment PO" : u"\u26DF 創造完成訂單+出貨單",
    u"+ PO" : u"+ 訂單",
    u"% discount" : u"% 折扣",
    u"Settings" : u"設置",
    u"\u2692 Create Product Order (PO)" : u"\u2692 創造訂單 (PO)",
    ...
    u'All units have shipped.' : u'訂單量已出貨完畢.',
    u"+ product" : u"+ 產品",
    u"PO #" : u"訂單編號",
    u"Order (PO) #:" : "訂單編號:",
    ...
    u"\u26D4 Cancel" : u"\u26D4 取消",
    u"NOTE:" : u"備註:",
    u'Verify these entries:' : u'確認以下內容:',
    u"Edit PO" : u"編輯訂單",
    u"Product" : u"產品",
    u'Active POs' : u'使用中的訂單',
    u'Manage POs' : u'管理訂單',
    u'Order Products' : u'創造訂單(+出貨單)',
    u'All POs' : u'所有訂單',
    ...
    u'Note:' : u'備註:',
    u'Auto check for updates' : u'自動檢查更新',
    u'Current Price:' : u'目前的價格:',
    u"Check for update" : u"檢查更新",
    u'Update' : u'更新',
    u'Language' : u'語言選擇',
    u'Clear fields' : u'刪除字段',
    u'Clear' : u'刪除',
    u'Save changes to product' : u'儲存產品資料變更',
    u'Save changes' : u'儲存變更',
    ...
    u'Show All Similar Products' : u'列出所有類似的產品',
